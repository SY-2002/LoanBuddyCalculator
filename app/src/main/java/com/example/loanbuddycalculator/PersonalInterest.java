...
public class PersonalInterest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        double annualRate = getIntent().getDoubleExtra("annualRate", 0);
        ...
        backPrevious.setOnClickListener(view -> {
            Intent intent = new Intent(PersonalInterest.this, PersonalLoan.class);
